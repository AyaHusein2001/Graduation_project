...
def get_database(description,entities_snake_case): 
    ...
    entities_snake_case_not_used,attributes_snake_case=predict_entities_and_attributes(description)
    # print(attributes_snake_case)
    ...
    return entities_with_attr, entities_with_pks, relationships
...
if __name__ == "__main__":
    ...
    output = {
        "entities_with_attr": entities_with_attr,
        "entities_with_pks": entities_with_pks,
